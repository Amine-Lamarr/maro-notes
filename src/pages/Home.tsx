...
export default function Home() {
  return (
    <div className="flex flex-col space-y-16 lg:space-y-32 py-4 sm:py-8 lg:py-12 relative px-2 sm:px-6 -mt-[10px] sm:-mt-[30px] overflow-hidden">
      {/* Hero Section */}
      <section className="grid lg:grid-cols-2 gap-10 lg:gap-8 items-center max-w-7xl mx-auto pt-4 sm:pt-8 md:pt-16 min-h-[50vh] md:min-h-[60vh] animate-in fade-in slide-in-from-bottom-4 duration-1000">
        
        <div className="space-y-6 sm:space-y-7 lg:space-y-10 max-w-3xl text-left mr-auto justify-self-start translate-x-0 lg:-translate-x-[50px] px-2 sm:px-0">
          <div className="space-y-3 sm:space-y-5">
            <div className="font-mono text-xs sm:text-sm uppercase tracking-widest text-[#2563EB] mb-2 sm:mb-4 inline-block bg-[#EFF6FF] border border-[#DBEAFE] px-4 sm:px-5 py-1.5 sm:py-2 rounded-full shadow-xs font-semibold">
              Premium Study Modules
            </div>
            
            <h1 className="font-serif text-[38px] sm:text-[53px] md:text-[63px] lg:text-[77px] leading-[1.08] sm:leading-[1.06] tracking-tight text-left text-navy drop-shadow-[0_4px_12px_rgba(0,0,0,0.18)] font-bold">
              Elevate your{" "}
          ...
          <p className="text-lg sm:text-2xl md:text-[29px] text-navy-muted font-light leading-relaxed drop-shadow-[0_1px_4px_rgba(0,0,0,0.06)] max-w-2xl">
            Structured modules designed for success. High-quality PAs and lectures in a secure, distraction-free environment.
          </p>

          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-6 pt-3">
            <Link to="/years" className="group w-full sm:w-auto flex items-center justify-center sm:justify-between gap-4 bg-white dark:bg-[#111] text-navy px-8 py-4 sm:px-10 sm:py-5 rounded-full font-medium hover:bg-[#F8FAFC] border border-[#E2E8F0] transition-all duration-300 shadow-sm hover:shadow-md">
        ...
        {/* Illustration Area */}
        <div className="relative w-full h-[260px] sm:h-[360px] md:h-[420px] lg:h-[480px] flex items-center justify-center px-2 sm:px-0">
      ...
      <section className="grid lg:grid-cols-2 gap-10 lg:gap-10 items-center max-w-6xl mx-auto animate-in fade-in slide-from-bottom-8 duration-1000 delay-150 relative px-2 sm:px-0">
        <div className="space-y-4 sm:space-y-8 lg:pr-10 relative z-10 text-center lg:text-left">
          <h2 className="title-text text-4xl sm:text-6xl md:text-7xl lg:text-8xl text-navy font-bold leading-[1.08] sm:leading-[1.05]">Seamless<br className="hidden lg:block" /> <span className="text-[#2563EB] italic">Access</span></h2>
          <p className="text-navy-muted text-base sm:text-xl md:text-2xl lg:text-3xl leading-relaxed font-normal max-w-xl mx-auto lg:mx-0">
