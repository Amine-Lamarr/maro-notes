      ...
      <div className="w-full max-w-xl p-6 sm:p-16 rounded-3xl sm:rounded-[3rem] bg-white border border-[#E2E8F0] shadow-[0_25px_65px_rgba(0,0,0,0.08)] relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 sm:space-y-10">
          <div className="space-y-2 sm:space-y-3">
            <h1 className="font-serif text-3xl sm:text-5xl font-extrabold text-[#0F172A] tracking-tight drop-shadow-sm">Welcome Back</h1>
            <p className="text-sm sm:text-lg text-[#475569] font-normal">Access your premium study materials</p>
          </div>
