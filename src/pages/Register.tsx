          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-1.5 flex flex-col">
                ...
                <input 
                  ...
                  className="bg-[#F8FAFC] border border-[#CBD5E1] rounded-xl px-5 py-4 text-base focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB]/50 transition-all font-mono placeholder:text-[#94A3B8] text-[#0F172A]"
                />
                <p className="text-xs text-[#64748B] ml-1 mt-1 font-mono">Must be at least 6 characters</p>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="text-center pt-2">
                ...
                <Link to="/login" className="text-sm small-caps text-[#0d0178] font-bold hover:text-[#2563EB] transition-colors">
                  Sign In
                </Link>
              </div>
            </div>
